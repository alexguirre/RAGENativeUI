namespace RAGENativeUI.TimerBars
{
    ...
    {
        internal const float DefaultXOffset = 0.145f + 0.001f;
        internal const float DefaultYOffset = 0.016f * 0.5f;
        ...
        public Vector2 Offset { get; set; } = new Vector2(DefaultXOffset, DefaultYOffset);
